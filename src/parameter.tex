...
\newcommand{\indentTOC}{1}
% Hier können Sie sich zwischen einem eingerückten oder einem nicht eingerückten Inhaltsverzeichnis (table of contents bzw. TOC) entscheiden
% `1` <-> eingerückt
% `0` <-> nicht eingerückt
