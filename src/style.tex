...
\newcommand{\insertOfficialDocs}{
     % Bibliographie
     \subsection{\ifnumequal{\semLanguage}{0}{Quellenangaben}{\ifnumequal{\semLanguage}{1}{References}{\ifnumequal{\semLanguage}{2}{Indiquer en référence}{Referencias}}}}
     \printbibliography[notkeyword={picture},heading=subbibliography,title={\ifnumequal{\semLanguage}{0}{Literaturverzeichnis}{\ifnumequal{\semLanguage}{1}{Literature}{\ifnumequal{\semLanguage}{2}{Littérature}{Literatura}}}}]
     \printbibliography[keyword={picture}, heading=subbibliography, title={\ifnumequal{\semLanguage}{0}{Bildquellen}{\ifnumequal{\semLanguage}{1}{Images}{\ifnumequal{\semLanguage}{2}{Photos}{Fotos}}}}]
     \newpage
 
     % Abbildungsverzeichnis
     \ifnumequal{\figureTable}{1}{
     \subsection{\ifnumequal{\semLanguage}{0}{Abbildungsverzeichnis}{\ifnumequal{\semLanguage}{1}{List of figures}{\ifnumequal{\semLanguage}{2}{Liste des figures}{Lista de figuras}}}}
     ...
     % Tabellenverzeichnis
    \ifnumequal{\tableTable}{1}{
    \subsection{\ifnumequal{\semLanguage}{0}{Tabellenverzeichnis}{\ifnumequal{\semLanguage}{1}{List of tables}{\ifnumequal{\semLanguage}{2}{Liste des tableaux}{Lista de tablas}}}}
    ...
    \newpage
     ...
     \noindent Hiermit erkläre ich, dass ich die vorliegende Arbeit selbständig und ohne fremde Hilfe verfasst und keine anderen als die angegebenen Hilfsmittel verwendet habe. \\
